...
def daily_txns_with_bar_data(transactions, market_data):
    ...
    transactions : pd.DataFrame
        Prices and numbers of executed trades. One row per trade.
...
def apply_slippage_penalty(
    ...
    backtest_starting_capital: capital base at which backtest was
        originally run. impact: See Zipline volume share slippage model
    impact : float
    ...
    portfolio_value = cum_returns(returns, starting_value=backtest_starting_capital) * mult
